...
export default function Features() {
  return (
    <section className="py-12 md:py-20">
      <div className="mx-auto max-w-7xl space-y-2 px-6 md:space-y-16">
        <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center md:space-y-12">
          <h2 className="text-balance text-4xl font-medium lg:text-5xl">
            The foundation for traders and investors
          </h2>
        </div>

        <div className="relative mx-auto grid max-w-full divide-x divide-y border *:p-12 *:py-24 sm:grid-cols-2 lg:grid-cols-3">
